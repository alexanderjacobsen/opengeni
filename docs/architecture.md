...
- **Env layering precedence (fixed):** deployment allowlist < git identity < workspace environment < run-scoped git auth (later wins); reserved/loader-injection names are rejected.
