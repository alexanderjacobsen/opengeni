...
| Integrations / connections / token broker | `apps/api/src/routes/connections.ts`, `packages/db/src/connection-token-resolver.ts`, `packages/runtime/src/index.ts` (`connectionRef`) | [`integrations-design.md`](integrations-design.md) |
