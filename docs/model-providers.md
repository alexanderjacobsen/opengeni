...
OPENGENI_OPENAI_MODEL=gpt-5.6
OPENGENI_OPENAI_ALLOWED_MODELS=gpt-5.6,gpt-5.6-sol,gpt-5.6-terra,gpt-5.6-luna
...
```
Clients then see `gpt-5.6`, the GPT-5.6 family variants, and `GLM 5.2` in the picker and can select any of them.
